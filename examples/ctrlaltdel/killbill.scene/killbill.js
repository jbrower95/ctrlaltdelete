...
var exported_scene = {
  ...
  onPresent : function() { 
    ...
    function loadObj(path, object, callback) {
    	var mtlLoader = new THREE.MTLLoader();
				...
				mtlLoader.load(object + ".mtl", function( materials ) {
					...
					objLoader.load( object + ".obj", function ( obj ) {
    ...
    loadObj("killbill.scene/sandman/", "sandman", function(object) {
    	bill = object;
	    object.position.y = 7;
    ...
    */
    ...
    var presentGun = function() {
    	loadObj("killbill.scene/1911/", "1911", function( object ) {
